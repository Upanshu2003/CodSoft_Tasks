...
Button(root, command = randPassGen, text = "Generate Password", font="Arial 11", bg='skyblue', fg='pink', activebackground="teal", padx=5, pady=5 ).pack(pady= 20)
...
Button(root, text = 'Copy to Clipboard', command = copyPass, font="Arial 10", bg='brown', fg='green', activebackground="teal", padx=5, pady=5 ).pack(pady= 20)
